...
_TFM_PARAMS = [
    ...
    {"key": "face_style_power",  "label": "Face style power",        "type": float, "default": 0.0,  "min": 0.0, "max": 1.0,  "help": "Source face style retention"},
    {"key": "bg_style_power",    "label": "BG style power",          "type": float, "default": 0.0,  "min": 0.0, "max": 1.0,  "help": "Background style retention"},
