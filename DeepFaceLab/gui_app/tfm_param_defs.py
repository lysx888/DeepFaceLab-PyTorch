...
TFM_PARAM_DEFS: list[ParamDef] = [
    ...
    ParamDef(key="face_style_power", label="脸部风格:", type=ParamType.FLOAT, default=2.0, min_val=0.0, max_val=5.0, step=0.1, decimals=2, group=ParamGroup.FACE_DETAIL),
    ParamDef(key="bg_style_power", label="背景风格:", type=ParamType.FLOAT, default=1.0, min_val=0.0, max_val=5.0, step=0.1, decimals=2, group=ParamGroup.FACE_DETAIL),
