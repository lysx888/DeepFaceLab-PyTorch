...
from DeepFaceLab.gui_app.theme import PRIMARY
from DeepFaceLab.gui_app.panels import (
    Step1VideoExtract, Step2FaceExtract, Step3XSeg,
    Step4Train, Step5Merge, Step6Output, Step7Tools, Step8Workspace,
)
from DeepFaceLab.gui_app.step_insightface_train import StepInsightFaceTrain
...
_STEPS = [
    ...
    ("9. IF训练", StepInsightFaceTrain),
]

_WINDOW_CTRL_SS = (
    "QPushButton { background-color: transparent; border: none; "
    "color: #FFFFFF; font-size: 16px; font-weight: bold; "
    "min-width: 46px; min-height: 48px; }"
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("DeepFaceLab PyTorch")
