...
rem PyTorch thread control - prevent CPU overload
rem Main process uses moderate threads; DataLoader workers use 1 thread each
...
SET DFL_ROOT=%ROOT_DIR%\DeepFaceLab
