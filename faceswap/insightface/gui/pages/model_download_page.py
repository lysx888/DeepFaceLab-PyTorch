...
class ModelDownloadPage(BasePage):
    ...
    def populate(self) -> None:
        ...
        self.url_label.setText(
            ...
            f"{tr('Local model root', language)}: {Path(self.context.config.model_root).expanduser()}"
        )
    ...
    def use_selected_model(self) -> None:
        ...
        if asset.name.endswith(".zip"):
            ...
            path = Path(self.context.config.model_root).expanduser() / asset.stem / asset.name
    ...
    def open_model_folder(self) -> None:
        folder = Path(self.context.config.model_root).expanduser()
