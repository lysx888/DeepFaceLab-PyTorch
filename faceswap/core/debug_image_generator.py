...
def draw_debug_image(
    ...
    """绘制调试图: 检测框 + 106点 + 可选 hull 遮罩。

    bbox 格式: [x1, y1, x2, y2] (左上/右下绝对坐标, 与元数据 source_rect 一致)。
    """
    ...
    if bbox is not None:
        ...
        cv2.rectangle(debug_img, (x1, y1), (x2, y2), (212, 120, 0), 2)
...
def save_debug_image(
    ...
    debug_img = draw_debug_image(source_img, landmarks_106, transform_mat, output_size, bbox, draw_hull)
