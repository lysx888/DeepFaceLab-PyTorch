...
class ManualAnnotatorDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        delete106_btn = QPushButton("删除106点")
        delete106_btn.setStyleSheet("QPushButton { background-color: #C42B1C; color: white; font-weight: bold; padding: 3px 8px; }")
        delete106_btn.clicked.connect(self._delete_106_only)
        align106_layout.addWidget(delete106_btn)
    ...
    def _delete_106_only(self):
        reply = QMessageBox.question(self, "确认删除", "是否要删除106点？",
                                     QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No)
        if reply == QMessageBox.StandardButton.Yes:
            self._canvas.clear_landmarks()
            self._status.setText("106点已删除")
