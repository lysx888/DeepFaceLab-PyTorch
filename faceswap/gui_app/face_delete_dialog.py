...
class FaceDeleteDialog(QDialog):
    ...
    def __init__(self, aligned_dir: Path, parent=None):
        ...
        self._widget_cache: dict[Path, _ThumbWidget] = {}
    ...
    def _build_ui(self):
        ...
        hint_lbl = QLabel("支持Shift多选或Ctrl多选")
    ...
    def _start_loading(self):
        ...
        self._grid_cols = max(1, self.width() // 116)
        show_highlight = self._sort_combo.currentText() == "文件名"
        self._prefix_groups = self._compute_prefix_groups() if show_highlight else set()
        self._update_dup_info()
    ...
    def _populate_grid(self):
        ...
        for i, p in enumerate(self._current_order):
            ...
            self._grid_layout.addWidget(tw, row, col)
            new_widgets.append(tw)
        self._thumb_widgets = new_widgets
